...
class DonutChartView: UIView {
    ...
    init(frame: CGRect, title: String, value: Double) {
        ...
        shapeLayer.position = convert(center, to: self.coordinateSpace)
        ...
        addSubview(content)
        content.anchor(top: topAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor, padding: .init(top: 0, left: 0, bottom: 0, right: 0))
